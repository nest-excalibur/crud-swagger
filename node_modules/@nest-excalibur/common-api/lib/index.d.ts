...
export { FindFullQuery } from './api/functions/search/complex-search/interfaces/find-full-query';
...
export { SimpleQueyOperator } from './api/functions/search/complex-search/interfaces/simple-quey-operator';
